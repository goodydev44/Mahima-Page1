      ...
      <div className='grid grid-cols-1 gap-10'>
        <div className='grid md:grid-cols-2 gap-5'>
          <div className='relative bg-[#82beaa] flex justify-center pt-16'>
            <img src={PS5} className='mobile:h-[400px] lg2:h-[450px] xl:h-[500px]' />
          ...
          <div className='grid grid-cols-1 gap-5'>
            <div className='bg-[#ccd9e5] flex gap-2 mobile:justify-evenly md:justify-between items-center mobile:py-5 md:py-0 px-5'>
              ...
              <img src={Group} className='mobile:h-[160px] lg2:h-[180px] xl:h-[200px]' />
            </div>

            <div className='grid grid-cols-2 gap-5'>
              <div className='relative bg-[#d1aab3] flex justify-center items-center mobile:py-5 md:py-0 px-5'>
                <img src={speakers} className='mobile:h-[140px] lg2:h-[160px] xl:h-[180px]' />
        ...
        <div className='flex mobile:flex-col lg:flex-row mobile:gap-y-20 lg:gap-x-10 justify-between items-center bg-[#bcb8d7] px-10 py-12'>
